...
def main(num: str):
    ...
    context_message = file_reader("/home/mahbubah/Desktop/week-7/Prompt-Tuning-Precision-RAG/prompts/context.txt")
    prompt_message = file_reader("/home/mahbubah/Desktop/week-7/Prompt-Tuning-Precision-RAG/prompts/prompt-generating-prompt.txt")
